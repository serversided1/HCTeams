...
public class ToggleLightningCommand {
    ...
    public static void toggleLightning(Player sender) {
        boolean val = !FoxtrotPlugin.getInstance().getToggleLightningMap().isLightningToggled(sender.getUniqueId());
        ...
        FoxtrotPlugin.getInstance().getToggleLightningMap().setLightningToggled(sender.getUniqueId(), val);
    }
