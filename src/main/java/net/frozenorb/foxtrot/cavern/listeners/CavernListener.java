package net.frozenorb.foxtrot.cavern.listeners;
...
import net.frozenorb.foxtrot.cavern.Cavern;
...
public class CavernListener implements Listener {
    ...
    public void onBlockBreak(BlockBreakEvent event) {
        ...
        if (Foxtrot.getInstance().getServerHandler().isUnclaimedOrRaidable(location) || !cavernHandler.hasCavern()) {
            return;
        }
