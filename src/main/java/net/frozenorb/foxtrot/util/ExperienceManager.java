...
public final class ExperienceManager {
    ...
    private void setExp(double base, double amt) {
        ...
        // Increment total experience - this should force the server to send an
        // update packet
        if (xp > base) {
     ...
     * @throws IllegalArgumentException if the level is less than 0 or greater than the current hard
     *                                  maximum
     */
