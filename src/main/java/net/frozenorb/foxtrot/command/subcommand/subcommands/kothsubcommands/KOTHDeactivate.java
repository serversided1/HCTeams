 ...
 */
public class KOTHDeactivate extends Subcommand {

    public KOTHDeactivate(String name, String errorMessage, String... aliases) {
    ...
    public void syncExecute() {
        if (sender.hasPermission("foxtrot.koth")) {
            ...
            if (!koth.isActive()) {
                sender.sendMessage(ChatColor.RED + "Error: KOTH is not active.");
                return;
            }

            koth.deactivate(false);
        }
    }
