...
public class DeathTracker {
    ...
    public static void logDeath(Player player, Player killer) {
        ...
        File logTo = new File(logToFolder, player.getName() + "-" + (killer == null ? "null" : killer.getName()) + "-" + (System.currentTimeMillis() / 1000) + ".log");
        ...
        try {
            ...
            if (killer != null) {
                ...
                for (PotionEffect potionEffect : killer.getActivePotionEffects()) {
                    ...
                    potionEffectDBObject.put("Duration", TimeUtils.getMMSS(potionEffect.getAmplifier() / 20));
