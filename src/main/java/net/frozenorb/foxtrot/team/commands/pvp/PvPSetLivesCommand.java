...
public class PvPSetLivesCommand {
    ...
    public static void pvpSetLives(Player sender, @Parameter(name="player") OfflinePlayer target, @Parameter(name="Life Type") String lifeType, @Parameter(name="Amount") int amount) {
        if (lifeType.equalsIgnoreCase("soulbound")) {
            FoxtrotPlugin.getInstance().getSoulboundLivesMap().setLives(target.getUniqueId(), amount);
            ...
            FoxtrotPlugin.getInstance().getFriendLivesMap().setLives(target.getUniqueId(), amount);
            ...
            FoxtrotPlugin.getInstance().getTransferableLivesMap().setLives(target.getUniqueId(), amount);
