...
public class TeamUnIgnoreCommand {
    ...
    @Command(names = {"team unignore", "t unignore", "f unignore", "faction unignore", "fac unignore"}, permissionNode = "")
    public static void unignoreTeam(Player sender, @Parameter(name = "team") String target) {
